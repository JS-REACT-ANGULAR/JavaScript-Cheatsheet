...
//Any Function expression (VAR, LET, CONST) will not be hoisted
...
var greet2 = function() { console.log("var greet2 = function()" + " Hello") } //Not Hoisted

var greet3 = () => { console.log("var greet3 = () =>" + " Hello") }

let greet4 = function() { console.log("let greet4 = function()") }

let greet5 = () => { console.log("let greet5 = () =>") }

const greet6 = function() { console.log("const greet6 = function()") }

const greet7 = () => { console.log("const greet7 = () =>") }