...
//bind()
//unlike call(), bind() does not call the function right away but returns the borrowed function which can be clled later

indianCook.cookPalakPaneer.bind(italianCook, "Turmeric");