...
let compose2 = (...functions) => value => functions.reduceRight((previousFunc, currentFunction) => currentFunction(previousFunc), value);
...
let pipe2 = (...functions) => value => functions.reduce((previousFunc, currentFunction) => currentFunction(previousFunc), value);
